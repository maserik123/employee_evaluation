    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class="text-right">
                <button class="btn btn-primary btn-xs" onclick="showNormalization()" type="button"><i class="fa fa-cogs"></i> Normalization Calculation</button>
                    ...
                    <?php foreach ($getCriteria as $row) { ?>
                        <div class="item form-group">
                            ...
                            <div class="col-md-12 col-sm-9 col-xs-12">
                                ...
                                <input type="text" id="value[<?php echo $row->criteria_code; ?>]" name="value[<?php echo $row->criteria_code; ?>]" required="required" placeholder="" class="form-control ">
                            </div>
                        </div>
                    <?php } ?>
                </div>
