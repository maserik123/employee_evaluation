<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <div class="sidebar-heading">
        Akses Login : [ <?php echo $this->session->userdata('role'); ?> ]
    </div>
    <!-- Nav Item - Dashboard -->
    <?php if (($this->session->userdata('role') == 'sys_manager') || ($this->session->userdata('role') == 'admin') || ($this->session->userdata('role') == 'supervisor')) { ?>
    ...
    <?php if (($this->session->userdata('role') == 'sys_manager') || ($this->session->userdata('role') == 'supervisor')) { ?>
